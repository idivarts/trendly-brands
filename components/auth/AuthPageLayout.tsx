...
const AuthPageLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <LinearGradient colors={BACKGROUND_GRADIENT} style={authLayoutStyles.background}>
            <KeyboardAvoidingView
                behavior={Platform.OS === "ios" ? "padding" : "height"}
                style={authLayoutStyles.flex}
            >
                <View
                    style={[
                        authLayoutStyles.page,
                        authLayoutStyles.contentRow,
                        !isWideLayout && authLayoutStyles.contentColumn,
                    ]}
                >
                    {isWideLayout && (
                        <View
                            style={[
                                authLayoutStyles.leftPane,
                                !isWideLayout && authLayoutStyles.leftPaneStacked,
                            ]}
                        >
