            ...
            case "star-rating": {
                ...
                return (
                    <View style={styles.optionsContainer}>
                        ...
                        >
                            <Text style={[styles.anyQualityText, value === undefined && { color: Colors(theme).white }]}>
                                Any quality
                            </Text>
                        </Pressable>
                        {value !== undefined && (
...
const styles = StyleSheet.create({
    ...
    othersChip: {
        borderWidth: 1,
        borderColor: ColorsStatic.overlayBlack20,
    },
    ...
    locationSheetItem: {
        ...
        padding: 16,
        borderBottomWidth: 1,
        borderBottomColor: ColorsStatic.overlayBlack08,
    },
    ...
    singleSelectOption: {
        backgroundColor: ColorsStatic.overlayBlack03,
        borderRadius: 12,
        padding: 16,
        borderWidth: 2,
        borderColor: ColorsStatic.transparent,
    },
    radioContainer: {
        flexDirection: "row",
        alignItems: "center",
    ...
    radioOuter: {
        ...
        borderRadius: 10,
        borderWidth: 2,
        borderColor: ColorsStatic.borderDefault,
    ...
    anyQualityChip: {
        ...
        borderRadius: 20,
        borderWidth: 2,
        borderColor: ColorsStatic.overlayBlack15,
    },
    anyQualityText: {
        fontSize: 15,
        fontWeight: "600",
    ...
    footer: {
        paddingTop: 20,
        borderTopWidth: 1,
        borderTopColor: ColorsStatic.overlayBlack10,
    },
    buttonContainer: {
        flexDirection: "row",
        justifyContent: "space-between",
