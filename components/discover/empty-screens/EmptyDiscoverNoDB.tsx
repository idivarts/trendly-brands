...
const databases = [
    { key: "trendly", title: "Trendly", description: "30,000+ Indian micro-influencers. Built for startups. Included in Pro (₹1,500/mo).", icon: "star" },
    { key: "phyllo", title: "Phyllo", description: "250M+ global creators. Enterprise reach at a fraction of direct cost.", icon: "earth" },
    { key: "modash", title: "Modash", description: "250M+ creators. Perfect for scale and niche targeting.", icon: "flash" },
];
...
function makeStyles(colors: ReturnType<typeof Colors>) {
    return StyleSheet.create({
        container: { padding: 24, backgroundColor: colors.tag || colors.card, flex: 1 },
        banner: { borderRadius: 16, paddingVertical: 22, paddingHorizontal: 16, marginBottom: 12 },
        bannerTitle: { fontSize: 22, fontWeight: "800", textAlign: "center", letterSpacing: 0.2, color: colors.text },
        bannerSubtitle: { color: colors.textSecondary, marginTop: 6, textAlign: "center" },
        pillsRow: { flexDirection: "row", justifyContent: "center", gap: 8, marginTop: 12, flexWrap: "wrap" },
        pill: { backgroundColor: colors.card, paddingVertical: 6, paddingHorizontal: 10, borderRadius: 999, marginHorizontal: 4, marginVertical: 4 },
        pillText: { fontSize: 12, fontWeight: "600", color: colors.text },
        subtext: { color: colors.textSecondary, marginTop: 8, marginBottom: 24, textAlign: "center", lineHeight: 20 },
        cardRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 24 },
        card: { flex: 1, marginHorizontal: 6, elevation: 3, borderRadius: 12, paddingVertical: 6, backgroundColor: colors.card },
        avatar: { backgroundColor: colors.border, alignSelf: "center", marginBottom: 10 },
        tip: { marginTop: 18, fontStyle: "italic", color: colors.textSecondary, textAlign: "center" },
        cardTitle: { fontSize: 18, fontWeight: "700", marginTop: 6, marginBottom: 2, textAlign: "center", lineHeight: 24, color: colors.text },
        cardDescription: { fontSize: 15, color: colors.textSecondary, textAlign: "center", lineHeight: 20 },
