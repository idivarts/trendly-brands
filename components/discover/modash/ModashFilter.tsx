...
// --------------------
// Extracted Filters (formerly inside ScrollView)
// --------------------
const ModashFilter = () => {
    const theme = useTheme()
    const colors = Colors(theme)
    const styles = useMemo(() => styleFnFilters(colors), [colors])
...
const styleFnFilters = (colors: any) => StyleSheet.create({
    scroll: {
        padding: 12,
        gap: 8,
    },
