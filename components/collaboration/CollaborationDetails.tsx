...
import CollaborationApplicationPage from "@/app/(main)/(screens)/collaboration-details/applications";
import CollaborationInvitationPage from "@/app/(main)/(screens)/collaboration-details/invitations";
