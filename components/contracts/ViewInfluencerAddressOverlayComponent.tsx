...
const ViewInfluencerAddressOverlay: React.FC<ViewInfluencerAddressOverlayProps> = ({
    visible,
    onClose,
    influencerName,
    address,
                        ...
                        {onNudgeForAddress ? (
                            <>
                                <Text style={styles.noAddressHint}>
                                    Ask the influencer to complete KYC with a valid shipping address.
                                </Text>
                                <Button
                                    mode="contained"
                                    onPress={handleNudge}
...
function createStyles(colors: ReturnType<typeof Colors>, safeAreaTop: number) {
    return StyleSheet.create({
        ...
        addressLines: { flex: 1, marginLeft: 12 },
        addressLine: { fontSize: 15, color: colors.text, lineHeight: 22 },
        noAddressBlock: { marginBottom: 20 },
...
export default ViewInfluencerAddressOverlay;
