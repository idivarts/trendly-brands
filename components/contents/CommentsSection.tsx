...
function rowStyles(colors: ReturnType<typeof Colors>) {
    return StyleSheet.create({
        ...
        avatarText: { fontSize: fs(12), fontWeight: "700", color: colors.primary },
        avatarTextSm: { fontSize: fs(9) },
        body: { flex: 1, gap: 3 },
        meta: { flexDirection: "row", alignItems: "center", gap: 8 },
        author: { fontSize: fs(13), fontWeight: "600", color: colors.text },
        ts: { fontSize: fs(11), color: colors.textSecondary },
        resolvedTag: {
            paddingHorizontal: 5,
            paddingVertical: 2,
            borderRadius: 4,
        ...
        resolvedTagText: { fontSize: fs(10), fontWeight: "600", color: colors.primary },
        text: { fontSize: fs(13), color: colors.text, lineHeight: lh(18) },
        actions: { flexDirection: "row", gap: 14, marginTop: 2 },
        actionBtn: { flexDirection: "row", alignItems: "center", gap: 4 },
        actionText: { fontSize: fs(11), color: colors.textSecondary },
...
function sectionStyles(colors: ReturnType<typeof Colors>) {
    return StyleSheet.create({
        ...
        replyBannerText: { fontSize: fs(12), color: colors.primary, fontWeight: "600" },
        replyBannerCancel: { fontSize: fs(12), color: colors.textSecondary },
        compose: {
            flexDirection: "row",
            alignItems: "flex-end",
            gap: 8,
        ...
        sendBtnText: { fontSize: fs(13), fontWeight: "700", color: colors.onPrimary },
        btnPressed: { opacity: 0.72 },
    });
}
