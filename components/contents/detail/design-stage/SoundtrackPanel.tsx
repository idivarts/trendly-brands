    ...
    useMemo(
        () =>
            StyleSheet.create({
                ...
                title: { fontSize: fs(15), fontWeight: "600", color: colors.text },
                meter: { width: 90 },
                doneBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, backgroundColor: colors.primary },
                doneBtnText: { fontSize: fs(13), fontWeight: "700", color: "#fff" },
                searchRow: {
                    flexDirection: "row",
                    alignItems: "center",
                    gap: 8,
                ...
                search: { flex: 1, color: colors.text, fontSize: fs(13) },
                chips: { flexDirection: "row", flexWrap: "wrap", gap: 6 },
                chip: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 99, backgroundColor: colors.tag },
                chipActive: { backgroundColor: colors.primary },
                chipText: { fontSize: fs(12), color: colors.text, textTransform: "capitalize" },
                ...
                list: { gap: 4 },
                empty: { fontSize: fs(12), color: colors.textSecondary, paddingVertical: 8 },
                sectionLabel: { fontSize: fs(12), fontWeight: "500", color: colors.textSecondary, marginTop: 2 },
                ...
                rowMeta: { flex: 1 },
                rowTitle: { fontSize: fs(13), fontWeight: "500", color: colors.text },
                voAddedTitle: { flex: 1, fontSize: fs(13), fontWeight: "500", color: colors.text },
                voDuration: { fontSize: fs(12), fontWeight: "600", color: colors.textSecondary, fontVariant: ["tabular-nums"] },
                rowSub: { fontSize: fs(11), color: colors.textSecondary },
                added: { fontSize: fs(12), color: colors.primary, fontWeight: "500" },
                useBtn: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 8, backgroundColor: colors.tag },
                useBtnText: { fontSize: fs(12), color: colors.text },
                playBtn: {
                    width: 32,
                    height: 32,
                    borderRadius: 16,
                ...
                toggleLabel: { fontSize: fs(13), color: colors.text },
                voHeader: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 4 },
                voTitle: { fontSize: fs(14), fontWeight: "600", color: colors.text, flex: 1 },
                voHint: { fontSize: fs(11), color: colors.textSecondary },
                scriptPreview: { flex: 1, backgroundColor: colors.tag, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 9 },
                scriptText: { fontSize: fs(12), color: colors.textSecondary },
                voGenBtn: { paddingHorizontal: 12, paddingVertical: 9, borderRadius: 8, backgroundColor: colors.primary },
                voGenText: { fontSize: fs(12), color: "#fff", fontWeight: "500" },
                volRow: { flexDirection: "row", alignItems: "center", gap: 10 },
                volLabel: { fontSize: fs(12), color: colors.textSecondary, width: 44 },
                ...
                volPct: { fontSize: fs(11), color: colors.textSecondary, width: 34, textAlign: "right" },
                error: { fontSize: fs(12), color: colors.error },
            }),
        [colors]
    );
