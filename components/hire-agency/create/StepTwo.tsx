...
import { HireType, IAgencyHire } from "@/types/AgencyHire";
...
const StepTwo: React.FC<StepTwoProps> = ({ hire, setHire, onNext, onBack }) => {
    ...
    const select = (type: HireType) =>
        setHire((prev) => ({ ...prev, hireType: type }));
        ...
        >
            ...
            <View style={styles.options}>
                <TypeOption
                    ...
                    description="A single fixed-scope project — ideal for testing a new strategy or product launch. Note: one-off projects tend to be more expensive per result than ongoing retainers."
                    selected={hire.hireType === "one-off"}
                ...
                <TypeOption
                    ...
                    selected={hire.hireType === "retainer"}
